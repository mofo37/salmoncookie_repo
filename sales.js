...
console.log("***");
pike.cookiesPerThisHour();
console.log(pike.cookiesPerHour);
console.log(pike.totalCookiesPerDay());
...
//     var hourTable = document.createElement('td');
//     hourTh.textContent = shop[i];
//     hourTable.appendChild(hourTh);
//   }
// };
// pike();
